...
# Assuming you have data in the form of sequences, where each sequence represents a time window of sensor data
...
def create_lstm_model():
    ...
    model.add(LSTM(128, return_sequences=True, input_shape=(sequence_length, feature_size)))
...
Epoch 44/50
10/10 [==============================] - 18s 2s/step - loss: 0.3988 - accuracy: 0.9535
Epoch 45/50
10/10 [==============================] - 17s 2s/step - loss: 0.3832 - accuracy: 0.9694
Epoch 46/50
10/10 [==============================] - 17s 2s/step - loss: 0.2439 - accuracy: 0.9623
Epoch 47/50
10/10 [==============================] - 18s 2s/step - loss: 0.1898 - accuracy: 0.9636
Epoch 48/50
10/10 [==============================] - 18s 2s/step - loss: 0.2078 - accuracy: 0.9743
Epoch 49/50
10/10 [==============================] - 17s 2s/step - loss: 0.1747 - accuracy: 0.9712
Epoch 50/50
10/10 [==============================] - 18s 2s/step - loss: 0.2632 - accuracy: 0.9747
